...
function listar() {
    $.ajax({
        ...
        url: "https://g6fca600b7dc97d-db202109242122.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message",
...
function listarRespuesta(items) {
    ...
    for (var i=0; i < items.length; i++) {
        tabla +=`<tr>
                   ...
                   <td><button type="button" class="btn btn-warning" onclick="editarRegistro(${items[i].id})">Editar</button></td>
                   <td><button type="button" class="btn btn-danger" onclick="borrarRegistro(${items[i].id})">Borrar</button></td>
                   </tr>`;
    }
